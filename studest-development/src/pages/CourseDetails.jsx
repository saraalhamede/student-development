...
export default function CourseDetails({ courses, materials, assignments, announcements, toggleAssignment }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-3xl border border-indigo-100 bg-gradient-to-r from-white to-indigo-50 p-6 shadow-soft">
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-start">
          <div>
            ...
            <h1 className="mt-4 text-3xl font-black text-slate-950">{course.title}</h1>
          ...
          <div className="min-w-56 rounded-2xl bg-white p-5 shadow-sm">
