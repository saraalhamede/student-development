...
export default function MaterialCard({ material, course }) {
  ...
  return (
    <article className="flex flex-wrap items-center gap-3 border-b border-slate-100 py-4 last:border-0 sm:flex-nowrap sm:gap-4">
      ...
      <Link to={`/materials?material=${material.id}`} className="btn-secondary ml-auto px-3 py-2 sm:ml-0">Open</Link>
    </article>
  );
}
